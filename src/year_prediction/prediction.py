...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Spark Model Prediction with Avro Input')
    parser.add_argument('--model_path', type=str, required=True,
                      help='Path to the saved model directory')
    parser.add_argument('--avro_path', type=str, required=True,
                      help='Path to input Avro file')
...
def main():
    ...
    try:
        ...
        predictions.select("track_id", "year", "prediction") \
