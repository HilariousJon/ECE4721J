                ...
                rec = {
                    ...
                    "analysis": {
                        "analysis_sample_rate": int(
                            song_compound["analysis_sample_rate"]
                        ),
                        ...
                        "time_signature_confidence": float(
                            song_compound["time_signature_confidence"]
                        ),
                        ...
                        "beats_confidence": h5f["analysis/beats_confidence"][
                            ()
                        ].tolist(),
                        "sections_start": h5f["analysis/sections_start"][()].tolist(),
                        "sections_confidence": h5f["analysis/sections_confidence"][
                            ()
                        ].tolist(),
                        "tatums_start": h5f["analysis/tatums_start"][()].tolist(),
                        "tatums_confidence": h5f["analysis/tatums_confidence"][
                            ()
                        ].tolist(),
                        "segments_start": h5f["analysis/segments_start"][()].tolist(),
                        "segments_confidence": h5f["analysis/segments_confidence"][
                            ()
                        ].tolist(),
                        "segments_loudness_start": h5f[
                            "analysis/segments_loudness_start"
                        ][()].tolist(),
                        "segments_loudness_max": h5f["analysis/segments_loudness_max"][
                            ()
                        ].tolist(),
                        "segments_loudness_max_time": h5f[
                            "analysis/segments_loudness_max_time"
                        ][()].tolist(),
                        "segments_pitches": h5f["analysis/segments_pitches"][
                            ()
                        ].tolist(),
                    ...
                    "metadata": {
                        ...
                        "artist_name": (
                            metadata_compound["artist_name"].decode()
                            if metadata_compound["artist_name"]
                            else None
                        ),
                        "artist_mbid": (
                            metadata_compound["artist_mbid"].decode()
                            if metadata_compound["artist_mbid"]
                            else None
                        ),
                        "artist_familiarity": float(
                            metadata_compound["artist_familiarity"]
                        ),
                        "artist_hotttnesss": float(
                            metadata_compound["artist_hotttnesss"]
                        ),
                        "artist_location": (
                            metadata_compound["artist_location"].decode()
                            if metadata_compound["artist_location"]
                            else None
                        ),
                        "artist_latitude": (
                            float(metadata_compound["artist_latitude"])
                            if metadata_compound["artist_latitude"]
                            else None
                        ),
                        "artist_longitude": (
                            float(metadata_compound["artist_longitude"])
                            if metadata_compound["artist_longitude"]
                            else None
                        ),
                        "genre": (
                            metadata_compound["genre"].decode()
                            if metadata_compound["genre"]
                            else None
                        ),
                        "artist_terms": [
                            t.decode() for t in h5f["metadata/artist_terms"][()]
                        ],
                        "artist_terms_freq": h5f["metadata/artist_terms_freq"][
                            ()
                        ].tolist(),
                        "artist_terms_weight": h5f["metadata/artist_terms_weight"][
                            ()
                        ].tolist(),
                        "similar_artists": [
                            s.decode() for s in h5f["metadata/similar_artists"][()]
                        ],
                        "release": (
                            metadata_compound["release"].decode()
                            if metadata_compound["release"]
                            else None
                        ),
                        "release_7digitalid": int(
                            metadata_compound["release_7digitalid"]
                        ),
                        "song_hotttnesss": float(metadata_compound["song_hotttnesss"]),
                        "song_id": metadata_compound["song_id"].decode(),
                        "title": (
                            metadata_compound["title"].decode()
                            if metadata_compound["title"]
                            else None
                        ),
